...
public class LogUtil {
	 ...
	 * @return
	 */
	public static LogUtil LooLog() {
		if (loolog == null) {
			loolog = new LogUtil(LoLo);
		}
		return loolog;
	}
