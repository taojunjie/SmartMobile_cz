...
import com.android.smartmobile.cz.view.ColorPickerDialog.OnColorChangedListener;
 ...
 * @version
 */
public class PopColorManager implements InitActivity {
	 ...
	 * @param mainMapView
	 */
	public PopColorManager(Context context, OnColorChangedListener listener,
			int initialColor) {
	...
	public void initView() {
		...
		ColorPickerView myView = new ColorPickerView(mContext, 300, 300);
		// 创建PopupWindow实例,200,150分别是宽度和高度
		popupWindow = new PopupWindow(myView, 300, 300);
		popupWindow.setBackgroundDrawable(mContext.getResources().getDrawable(
				R.drawable.right_menu_bg));
		// 设置动画效果
	...
	private class ColorPickerView extends View {
		...
		public ColorPickerView(Context context, int height, int width) {
			...
			// 外圈大小
			r = width / 2 * 0.5f - mPaint.getStrokeWidth() * 0.2f;

			// 中心圆参数
			mCenterPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
			mCenterPaint.setColor(mInitialColor);
			mCenterPaint.setStrokeWidth(6);
			centerRadius = (r - mPaint.getStrokeWidth() / 2) * 0.7f;// 内圈大小
