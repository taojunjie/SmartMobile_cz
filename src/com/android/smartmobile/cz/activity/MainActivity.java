...
import com.android.smartmobile.cz.util.SystemUtil;
...
import com.android.smartmobile.cz.view.pop.PopOneMapManager;
import com.android.smartmobile.cz.view.pop.PopPEManager;
...
public class MainActivity extends BaseActivity implements InitActivity {
	...
	private PopOneMapManager mainLeftListView;
	private PopPEManager mainWebView;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Constants.WHAT_REFRESH_SCALE_LEVER:
				...
				txt_main_scale_lever.setText("当前级别：第"
						+ bean.getLever()
						+ "级 查询缓冲范围："
						+ bean.getBuffer()
						+ "米 内存："
						+ new DecimalFormat("#.00").format(SystemUtil
								.getmem_UNUSED(mContext) / 1000f)
						+ "M "
						+ "/"
						+ new DecimalFormat("#.00").format(SystemUtil
								.getmem_TOLAL() / 1000f) + "M");
				break;
...
//						ll_main_right_title));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initData();
		// 配置文件初始化
		new InitConfigAsyncTask(mContext, MyApplication.mApp.sdbHelper)
		...
		// // String path
		// ="file:///mnt/sdcard/SmartMobile_cz/cache/tpk/规划道路.tpk";
		...
		mapView.setOnStatusChangedListener(new OnStatusChangedListener() {
			...
			public void onStatusChanged(Object arg0, STATUS arg1) {
				if (arg0 == mapView && arg1 == STATUS.INITIALIZED) {// 地图加载成功
					...
					mainLeftListView = new PopOneMapManager(mContext, mapView,
							ll_main_list_left, keyGraphicsLayer);

					mainWebView = new PopPEManager(mContext, mapView, ll_web);
...
//				.split(MyApplication.mApp.appConfigInfo.getResolution()));
//		
//		mapView.setMaxResolution(arrayOfDoubleres[0]);
//		mapView.setMinResolution(arrayOfDoubleres[arrayOfDoubleres.length - 1]);
//
//		LogUtil.LooLog().d(
//				"MaxResolution:" + arrayOfDoubleres[0] + "MinResolution:\n"
//						+ arrayOfDoubleres[arrayOfDoubleres.length - 1]);
	 ...
	 * @param modules
	 */
	private void initLeftMenuView(final List<ModuleBean> modules, int press) {
		// TODO Auto-generated method stub
