 ...
 * @version
 */
public class ExRightTitleAdapter extends BaseExpandableListAdapter {
	private Context mContext;
	// private List<List<GroupLayer>> childData;// 小组成员
	private List<TitleBean> groupData;// 大组成员
	private MapView mapView;

	/**
	 * 
	 */
	public ExRightTitleAdapter(Context context, List<TitleBean> catalogs,
			MapView mapView) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (view == null) {
			view = LayoutInflater.from(mContext).inflate(
					R.layout.ex_right_title_groups, null);
		}

		TextView title = (TextView) view
				.findViewById(R.id.txt_right_title_group_name);
